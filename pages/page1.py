...
# sys.path.insert(1, '/home/rben10/work/Music_project/others/Audio_streamlit_project/')

# import input

# # import input.uploaded_file_T as U_T
# # import input.uploaded_file_S as U_S
# # print(input.uploaded_file_T)  # Access the value of my_variable
# # filename.my_variable = 50
...
# st.write(input.uploaded_file_S)  # Access the imported variable
# # File upload
...
# if input.uploaded_file_T is not None:
#     if input.uploaded_file_S is not None:
#         TWO_PLOT_TIME_DOMAIN(input.uploaded_file_T,input.uploaded_file_S)
#         #TWO_PLOT_MEL_SPECTROGRAM(input.uploaded_file_T, input.uploaded_file_S)
